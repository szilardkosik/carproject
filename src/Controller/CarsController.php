...
class CarsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Users', 'Makes', 'Models', 'Fuels']
        ];
    ...
    public function view($id = null)
    {
        $car = $this->Cars->get($id, [
            'contain' => ['Users', 'Makes', 'Models', 'Fuels', 'Comments']
        ]);
    ...
    public function add()
    {
        ...
        $fuels = $this->Cars->Fuels->find('list', ['limit' => 200]);
        $this->set(compact('car', 'users', 'makes', 'models', 'fuels'));
    }
